...
export async function getAllPostsWithSlug() {
    ...
    //   }
    // `)
    return null;//data?.allArticles?.edges
  }
  ...
  export async function getAllProjects(){
    ...
    return null;//data?.allProjects?.edges;
}
...
export async function getAboutPage(){
    ...
    return null;//data?.allAbouts?.edges[0];
}
...
export async function getResume(){
  ...
  return null;//data?.allResumes?.edges[0];
}
...
export async function getSkillsPage(){
  ...
  return null;// data?.allSkillss?.edges[0];
}
